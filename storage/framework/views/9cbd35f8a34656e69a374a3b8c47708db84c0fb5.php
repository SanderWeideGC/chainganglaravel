 ...
 <div class="containerform">    
  ...
  <h3 align="center">Insert your recipes and images here!</h3>
    ...
    <div class="panel panel-default">
         ...
         <form method="post" action="<?php echo e(url('store_image/insert_image')); ?>"  enctype="multipart/form-data">
          <?php echo csrf_field(); ?>
     ...
     <div class="panel panel-default">
         ...
         <div class="table-responsive">
                <table class="table table-bordered table-striped">
                  ...
                  <tr>
                   <td>
                    <img src="store_image/fetch_image/<?php echo e($row->id); ?>"  class="img-thumbnail" width="70" />
                   </td>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/lucas/code/chainganglaravel/resources/views/store_image.blade.php ENDPATH**/ ?>