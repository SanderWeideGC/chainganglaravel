            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="hero-text">
                            <h2>Join Us Now</h2>
                            <h1>THE FITNESS & HEALTH PLATFORM</h1>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="feature-item set-bg" data-setbg="img/feature/feature-1.jpg">
                    ...
                    <p>The new way of group lessons<br/></p>
                    <a href="schedule" class="primary-btn f-btn">Apply Now</a>
                </div>
            </div>
            <div class="col-md-4">
                <div class="feature-item set-bg" data-setbg="img/feature/feature-2.jpg">
                    <h3>PERSONAL TRAINING</h3>
                    <p>Private lessons with one of our trainers<br/></p>
                    <a href="schedule" class="primary-btn f-btn">Go private</a>
                </div>
            </div>
            <div class="col-md-4">
                <div class="feature-item set-bg" data-setbg="img/feature/feature-4.jpg">
                    <h3>Food</h3>
                    <p>The platform if you are looking for a healthy meal shared with others</p>
                    <a href="schedule" class="primary-btn f-btn">Read More</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="about-text">
                    ...
                    <p class="short-details">Fitty is a fitness and health platform</p>
                    <p class="long-details">Success isn’t really that difficult. There is a significant portion of
                        the population here in The Netherlands, that actually want and need success to be hard! For
                        those of you who are serious about having more, doing more, giving more and being more.</p>
                    <a href="about-us" class="primary-btn about-btn">About us</a>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="about-img">
            ...
            <div class="row">
                <div class="col-lg-7 m-auto text-center">
                    <div class="section-title pl-lg-4 pr-lg-4 pl-0 pr-0">
                        ...
                        <p>Our Fitty experts can help you discover new training techniques and exercises that offer a
        ...
        <div class="row">
            <div class="col-lg-3 col-sm-6">
                <div class="classes-item set-bg" data-setbg="img/classes/class-1.jpg">
                    ...
                    <a href="schedule" class="primary-btn class-btn">Read More</a>
                </div>
            </div>
            <div class="col-lg-3 col-sm-6">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="section-title">
                    ...
                    <p>All the prices are including the full food schedule</p>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-4">
                <div class="single-price-plan">
                    ...
                    <ul>
                        <li>1 hour a day access to online classes</li>
                        <li>1 classes a choice per week</li>
                        <li> Free drinking package</li>
                        <li>1 free personal training</li>
                    </ul>
                    <a href="contact" class="primary-btn price-btn">Get Started</a>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="single-price-plan">
                    ...
                    <ul>
                        <li>Unlimited access to the online classes</li>
                        <li>2 classes a choice per week</li>
                        <li>Free drinking package</li>
            ...
            <div class="col-lg-4">
                <div class="single-price-plan">
                    ...
                    <ul>
                        <li>Unlimited access to the online classes</li>
                        <li>6 classes a choice per week</li>
                        <li>Free drinking package & clothing package</li>
...
<?php echo $__env->make("layout", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/lucas/code/chainganglaravel/resources/views/index.blade.php ENDPATH**/ ?>